...
public class API {
    ...
    public static final String HOST = "http://api.openweathermap.org/data/2.5/weather";

    public static final String OPEN_WEATHER_KEY = "e9c132971d8648208975f12e910ec7e8";

    public static String getApiCurrentCityById(String cityId) {
        return HOST + "?id=" + cityId + "&appid=" + OPEN_WEATHER_KEY;
    }

    public static String getApiCurrentCityByCoordinate(String lat, String lon) {
    ...
    public static String getApiCurrentCityNextDay(String cityId) {
        return "http://api.openweathermap.org/data/2" +
            ".5/forecast?id="+ cityId + "&cnt=5&appid=" + OPEN_WEATHER_KEY;
    }
